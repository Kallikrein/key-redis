...
```sh
$ npm install waterline-key-redis
```

[![NPM](https://nodei.co/npm/waterline-key-redis.png?downloads=true&stars=true)](https://nodei.co/npm/waterline-key-redis/)
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/waterline-key-redis/FAQ.md)
